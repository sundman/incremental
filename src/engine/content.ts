...
const jobList: JobDef[] = [
  ...
  },
  {
    ...
    baseYield: 0,
    accidentsPerHour: 0.5,
    accidentText: 'was caught by the saw blade',
    requires: ['sawmill'],
    staffs: 'sawmill',
  },
  {
    ...
    resource: 'bricks',
    baseYield: 0,
    accidentsPerHour: 0.3,
    accidentText: 'was burned at the kiln',
    requires: ['kiln'],
    staffs: 'kiln',
  },
  {
...
const nodeList: NodeDef[] = [
  ...
  // Crafting: turning raw materials into better ones.
  {
    ...
    kind: 'building',
    name: 'Sawmill',
    description: 'Cuts Wood into Planks. Each Sawmill needs a Sawyer to run it.',
  ...
  },
  {
    ...
    kind: 'building',
    name: 'Kiln',
    description: 'Fires Clay into Bricks, burning Wood. Each Kiln needs a Brickmaker to run it. The smoke slows growth a little.',
