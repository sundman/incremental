...
const nodeList: NodeDef[] = [
  ...
  },
  {
    ...
    kind: 'tech',
    name: 'Haste',
    description: 'A spell that hurries every builder, in every world.',
  ...
  },
  {
    ...
    kind: 'building',
    name: 'Lab Assistants',
    description: 'Extra hands make research finish sooner.',
    baseCost: { research: 150 },
    costGrowth: 1.6,
    tier: 2,
    maxLevel: 10,
    requires: ['scholar'],
    effects: [{ stat: 'speed:lab', kind: 'mul', amount: 1.1 }],
  },
  {
    id: 'scientificMethod',
    world: 'lab',
