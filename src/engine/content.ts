...
const nodeList: NodeDef[] = [
  ...
  },
  {
    ...
    kind: 'building',
    name: 'House',
    description: 'Proper homes with room for a family. Packing people in slows growth.',
  ...
  },
  {
    ...
    kind: 'building',
    name: 'Park',
    description: 'Trees and green lawns clean the air, so pollution slows growth less.',
  ...
  // ------------------------------------------------------------------ Lab
  {
    ...
    kind: 'building',
    name: 'Scholar',
    description: 'Produces Research. Scholars are paid for in Realm Food and keep eating it, but they live in the Lab and take no Realm housing or jobs.',
    baseCost: { food: 1000 },
    costGrowth: 1.5,
    tier: 1,
    upkeep: { food: 0.2 },
  ...
  },
  {
    ...
    kind: 'building',
    name: 'Lab Assistants',
    description: 'Extra hands make research finish sooner. They are hired with Realm Gold and, like Scholars, eat Realm Food but take no Realm housing or jobs.',
    baseCost: { gold: 25 },
    costGrowth: 1.6,
    tier: 2,
    maxLevel: 10,
