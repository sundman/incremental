...
const nodeList: NodeDef[] = [
  ...
  },
  {
    ...
    kind: 'building',
    name: 'Park',
    description: 'Trees and green lawns clean the air, so pollution slows growth less. Needs Forestry from the Lab.',
    baseCost: { wood: 60, stone: 40, food: 40 },
    costGrowth: 1.6,
    tier: 2,
    maxLevel: 5,
    requires: ['well', 'forestry'],
  ...
  },
  {
    ...
    kind: 'tech',
    name: 'Forestry',
    description: 'Managed woodland: the Realm\'s forest regrows twice as fast, and the Realm can plant Parks.',
