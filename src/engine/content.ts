...
const nodeList: NodeDef[] = [
  ...
  },
  {
    ...
    kind: 'tech',
    name: 'Cartography',
    description: 'Map the lands around the Realm: 1 more square of land to build on, kept through Lab resets. Repeatable up to 10 times, each costing twice as much. Lets you send Expeditions.',
  ...
  },
  {
    ...
    kind: 'tech',
    name: 'Expedition',
    description: 'Explore beyond the maps. Each expedition finds 5 more squares of land for the Realm, kept through Lab resets. Repeatable.',
